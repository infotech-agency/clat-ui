...
export default function TestimonialsPage() {
  ...
  useEffect(() => {
    getTestimonials()
      .then((t) => setTestimonials(t.sort((a, b) => a.sortOrder - b.sortOrder)))
      .catch(() => {})
        ...
        <div className="container mx-auto">
          {loading ? (
            ...
            <div className="rounded-2xl border border-dashed border-border bg-navy-50 p-12 text-center">
              <p className="text-muted-foreground">Testimonials will appear here once published.</p>
            </div>
          ) : (
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {testimonials.map((t) => {
                ...
                return (
                  <div key={t._id || t.youtubeUrl} className="overflow-hidden rounded-2xl border border-border shadow-sm">
                    <div className="relative aspect-video bg-navy-800">
                      {isPlaying && ytId ? (
                        ...
                        <button onClick={() => setPlaying(t.youtubeUrl)} className="group relative h-full w-full" aria-label={`Play: ${t.title}`}>
                          {thumb ? (
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="mt-2 font-heading font-semibold text-navy">{t.title}</h3>
