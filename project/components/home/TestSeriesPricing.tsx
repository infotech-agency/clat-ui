    ...
    <section className="bg-white py-16 md:py-24">
      <div className="container mx-auto">
        <SectionHeading
          kicker="Blossom Test Series"
          title="Mock Packages for Every Stage"
          description="Pick the test series that matches your prep stage — from the 5-test Startup pack to the 100-mock Ultimate series covering CLAT, AILET, MH-CET, SLAT and ALS."
        />
